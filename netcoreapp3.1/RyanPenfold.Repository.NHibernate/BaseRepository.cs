...
namespace RyanPenfold.Repository.NHibernate
{
    ...
    public abstract class BaseRepository<T> : IRepository<T> where T : class
    {
        ...
        public virtual string NewId(string propertyName)
        {
            ...
            var configurationSection = Configuration.Configuration.ConfigurationSection;
            ...
            try
            {
                ...
                sqlconnection = new SqlConnection(RyanPenfold.Configuration.ConnectionStrings.Get(configurationSection.ConnectionStringName));
